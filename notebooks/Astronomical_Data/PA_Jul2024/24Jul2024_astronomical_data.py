...
LAT      =  9.338212
LON      = -82.258937
START    = '2024-07-24 18:30'          # local time,  YYYY-MM-DD HH:MM
END      = '2024-07-25 06:30'          # local time,  YYYY-MM-DD HH:MM
INTERVAL = 1                           # minutes between rows
OUTPUT         = '07242024_PA_Astronomical_Data.csv'
WINDOWS_OUTPUT = '07242024_PA_Dark_Windows.csv'
