...
LAT      =  9.338212
LON      = -82.258937
START    = '2024-07-23 18:30'          # local time,  YYYY-MM-DD HH:MM
END      = '2024-07-24 06:30'          # local time,  YYYY-MM-DD HH:MM
INTERVAL = 1                           # minutes between rows
OUTPUT         = '07232024_PA_Astronomical_Data.csv'
WINDOWS_OUTPUT = '07232024_PA_Dark_Windows.csv'
