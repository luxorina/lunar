...
LAT      =  9.338212
LON      = -82.258937
START    = '2025-04-15 18:30'          # local time,  YYYY-MM-DD HH:MM
END      = '2025-04-16 06:30'          # local time,  YYYY-MM-DD HH:MM
INTERVAL = 1                           # minutes between rows
OUTPUT         = '04152025_PA_Astronomical_Data.csv'
WINDOWS_OUTPUT = '04152025_PA_Dark_Windows.csv'
